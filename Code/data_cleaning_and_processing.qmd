...
path_raw_data = os.path.join(current_working_dir, 'Original-Data')
path_cleaned_data = os.path.join(current_working_dir, 'Cleaned-Data')
```
...
stl_city_tracts_demo = pd.read_csv(os.path.join(path_raw_data, 'census_tract_demos.csv')).iloc[[0]]
...
stlcounty_tracts_demo = pd.read_csv(os.path.join(path_raw_data, 'stlcounty_tracts.csv')).iloc[[0]]
...
stl_select.to_file(os.path.join(path_cleaned_data, 'stl_select.geojson'), driver='GeoJSON')

#New proposed city boundries with dissolve
newstl.to_file(os.path.join(path_cleaned_data, 'newstl.geojson'), driver='GeoJSON')

#New county boundries with dissolve (minus stl)
newcounty.to_file(os.path.join(path_cleaned_data, 'newcounty.geojson'), driver='GeoJSON')

#New county boundries with dissolve (incl stl)
county_all.to_file(os.path.join(path_cleaned_data, 'county_all.geojson'), driver='GeoJSON')
```
