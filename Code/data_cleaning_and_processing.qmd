...
```{python}
stl_tracts = gpd.read_file('stl_tracts.geojson')
stl_tracts = gpd.GeoDataFrame(stl_tracts[['COUNTYFP', 'NAME', 'NAMELSADCO', 'ALAND',
                                          'AWATER', 'geometry']])

stl_city_tracts_demo = pd.read_csv('census_tract_demos.csv').iloc[[0]]
...
stlcounty_tracts_demo = pd.read_csv('stlcounty_tracts.csv').iloc[[0]]
